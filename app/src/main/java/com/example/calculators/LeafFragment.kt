...
import com.example.calculators.databinding.FragmentLeafBinding

class LeafFragment : Fragment(R.layout.fragment_leaf) {
    private var _binding: FragmentLeafBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentLeafBinding.inflate(inflater, container, false)
        return binding.root
    }
